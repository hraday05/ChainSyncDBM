-- ============================================
-- ChainSync India Region - Database Init
-- ============================================

USE chainsync_india;

-- Wallets: Each user has an RSA key pair and balance
...
-- Transactions: Each transaction is hashed and signed
...
-- Blocks: Blockchain ledger with Merkle root and Proof of Work
...
-- Replication Log: Tracks cross-region data sync
...
-- Insert Genesis Block (Block #0 — the start of the chain)
